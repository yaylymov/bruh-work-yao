...
![Build](https://github.com/yaylymov/bruh-work-yao/workflows/Build/badge.svg)
[![Version](https://img.shields.io/jetbrains/plugin/v/MARKETPLACE_ID.svg)](https://plugins.jetbrains.com/plugin/MARKETPLACE_ID)
[![Downloads](https://img.shields.io/jetbrains/plugin/d/MARKETPLACE_ID.svg)](https://plugins.jetbrains.com/plugin/MARKETPLACE_ID)

# !!!!!!!!! IMPORTANT !!!!!!!!!

Please use your own OpenAI API Key. You can create your own API Key [here](https://platform.openai.com/api-keys).

If you somehow can't create an API Key, please contact me and I will provide you one to test the plugin.
Please do not just withdraw my internship application just because the plugin doesn't work because of the API Key.
Thank you!
...
- Manually:
  ...
  Download the [latest release](https://github.com/yaylymov/bruh-work-yao/releases/latest) and install it manually using
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>⚙️</kbd> > <kbd>Install plugin from disk...</kbd>
